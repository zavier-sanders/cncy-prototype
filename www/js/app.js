...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, RestangularProvider) {
  ...
  RestangularProvider.addResponseInterceptor(function(data, operation, what, url, response, deferred) {
          ...
          if (operation === "getList") {
            ...
            extractedData.paging = data.pagination;
          } else {
  ...
  // RestangularProvider.setDefaultHeaders({'Access-Control-Allow-Origin' : 'http://localhost:8100'})

  RestangularProvider.setBaseUrl('https://www.eventbriteapi.com/v3')
  RestangularProvider.setDefaultRequestParams({ token: "QM2ZFAJ3ASDY54J6RLLB" })
  ...
  .state('app.news-article', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/news-article.html"
        // controller: 'BookMarksCtrl'
      }
    }
  })
  ...
  .state('app.consulting', {
      ...
      views: {
          'menuContent': {
              templateUrl: "views/app/consulting.html"
              // controller:
            }   
        }
  })
 ...
 .state('app.careers', {
      ...
      views: {
          'menuContent': {
              templateUrl: "views/app/careers.html"
              // controller:
            }   
        }
  })
